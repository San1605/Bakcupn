  ...
  return (
    ...
    <div className='landing_background'>
      ...
      <div className='landing_div'>
        ...
        <p className='heading_text mb-0 ms-3 '>Welcome to the Future of Intelligence: Explore the Power of AI!</p>
        </div>
        {/* <div className='text heading_text mb-0'><p>Explore the Power of AI!</p></div> */}
        <div className='d-flex gap-4 mt-5'><button className= 'modify-btn' onClick={() => navigate("/modifyrfp")}>Modify Existing RFP</button>
        <button  className= 'modify-btn' onClick={() => navigate("/home")}>Create new RFP</button>
        </div>
      </div>
    </div>
    </div>
