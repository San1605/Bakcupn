...
let isOn=""
  ...
  return (
    <Document>
      <Page
        style={isOn === "English" ? styles.page : styles.page1}
        size="A4"
        wrap
      >
        {/* <View style={styles.section}>
          ...
          <View style={styles.confidentialview}>
            <Text style={styles.confidentialheadingtext}>
              {isOn === "English"
                ? "Confidential & Proprietary"
                : "سرية وملكية"}
            </Text>
            <Text style={styles.confidentialheadingsubtext}>
              {isOn === "English"
