...
import LOGIN_BG from "../../assets/pnbAssets/login__bg.png";
...
const Login = () => {
  ...
  const handleLogin = async (e, userId, password) => {
    e != "" && e?.preventDefault();
    let isUserIdValid = validateFormInput(
      "userId",
      userId ? userId : payload?.userId
    );
    let isPasswordValid = validateFormInput(
      "password",
  ...
  return (
    <div className="login-page h-full w-full">
      <div className="flex h-full h-full">
        <div className="hidden md:flex sm:w-[52%] bg-[#FBFCFF] h-full flex items-center justify-center">
          <img className="h-full w-full" src={LOGIN_BG} alt="" />
        </div>
        <div className="w-full sm:w-[48%] bg-white-900 h-full flex items-center lg:pl-[9rem] md:pl-[2rem] justify-center md:justify-start">
          <div className="h-3/5 lg:w-9/12 md:w-11/12 w-10/12 max-w-[31rem] pt-8">
            <div>
            ...
            <div className="login-form mt-6">
              ...
              <h4 className="text-[var(--black)] text-[14px]">
                Welcome to PNB chatbot, please enter your details to initiate
