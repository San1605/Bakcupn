...
const DataDrivenChat = () => {
  ...
  const [messages, setMessages] = useState([
    // {
    //   From: "User",
    //   Message: "Hello, may I ask some quaries",
    // },
    // {
    //   From: "Bot",
    //   Message:
    //     "Employees at PNB are required to change their passwords every 90 days. They should follow the company's password reset procedures in case of suspicion of unauthorized access or forgotten password. Sharing or disclosing login credentials with unauthorized individuals is strictly prohibited. Writing down passwords or storing them in easily accessible locations is not allowed. Prompt reporting of suspected security incidents or unauthorized access is mandatory. Employees should not ignore or bypass MFA requirements and should be cautious against phishing attempts.",
    //   blob_link: [
    //     "Https://Hello-World.com/wsef/werg",
    //     "Https://Hello-World.com/wsef/werg",
    //   ],
    //   Filenames: ["POL-TD-008_EMERGING...pdf", "POL-TD-003_TECHNOLOGY...pdf"],
    // },
  ]);
  ...
  return (
    <div
      className="data-driven-page h-full flex gap-2 w-full bg-[#fff]"
      id="main"
    >
                ...
                <>
                  <div className="flex ilustration-container w-full">
                    <div className="w-full">
                      ...
                      <div
                        className="messages-container-data-driven overflow-y-auto flex flex-col gap-5 px-6"
                        id="chats-container"
                      >
                        {messages?.map((msg, i) => {
                          return (
                            ...
                            >
                              <img
                              className="h-[44px] pt-2"
                                src={msg.From === "User" ? USER : BOT}
                                alt=""
                              />
                              {msg.From === "User" ? (
                                <div className="relative msg user-msg max-w-[85%] flex-start bg-[#C4E5FF] py-2 px-4 rounded-[17px]">
                                ...
                                <div
                                  className={`msg bot-msg max-w-[85%] flex-end bg-[#F8F8F8] py-2 px-4  rounded-[25px] mb-5 relative z-[3]`}
                                >
                                  <img
                    ...
                    >
                      ...
                      <div className="text-center">
                        ...
                        <p className="text-[#616161] text-sm max-w-[20rem]">
                          Welcome to our Data-Driven IT Policy Bot! Get
                          personalized answers based on 'PNB IT policy
                          documents'. Explore now!
                        </p>
                      </div>
                    </div>
                    <div className="suggestion-questions mb-5 w-[100%] sm:max-w-[54rem]">
