...
//chatbot
export const getBotResponse = async (user_msg, query_type, history) => {
...
//update prev conversation or create new
export const updateConversation = async (obj) => {
    ...
    data.append("query_type", obj.queryType);
    data.append("citetation", obj.citetation);
