...
import LOGIN_BG from "../../assets/loginBg.svg";
import BNM_NAMED_LOGO from "../../assets/bnmNamedLogo.png";
  ...
  return (
    <div className="login-page h-full w-full">
      <div className="flex h-full h-full">
        <div className="hidden md:flex sm:w-[56%] bg-[#FBFCFF] h-full flex items-center justify-center">
          <img className="h-2/3" src={LOGIN_BG} alt="" />
        </div>
        <div className="w-full sm:w-[44%] bg-white-900 h-full flex items-center lg:pl-[5rem] md:pl-[2rem] justify-center md:justify-start">
          <div className="h-3/5 lg:w-10/12 md:w-11/12 w-10/12 max-w-[31rem] pt-4">
            <div>
              <img className="w-[10rem]" src={BNM_NAMED_LOGO} alt="" />
            </div>
            <div className="login-form mt-6">
              <h4 className="font-medium text-[var(--black)] text-2xl ">
                Sign In
              </h4>
              <h4 className="text-[var(--black)] text-[17px]">
              ...
              <form onSubmit={handleLogin}>
                <div className="mt-2 h-[77px]">
                  ...
                  <input
                    className={`bg-[#F4F4F4] w-full p-2 text-sm rounded-[3px] login-input ${
                ...
                <div className="mt-5">
                  <button
                    className="bg-[#2957A4] text-white px-20 mt-1 py-[10px] rounded-[3px]"
                    type="submit"
                    disabled={loading}
                  >
                    Login
