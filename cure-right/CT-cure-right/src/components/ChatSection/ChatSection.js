        ...
        if (chatRoomId === null) {
          ...
          try {
            ...
            let payload = {
              ...
              receiverToken:
                chatClientUser?.tokenCredential?.tokenCredential?.token?.token,
            };
            try {
            ...
            chatThreadClientLocal =
              chatClientUser.getChatThreadClient(chatRoomId);
            ...
            chatClientUser.on("chatMessageReceived", (e) => {
              console.log(
                "Notification chatMessageReceived ifffffffffffffffffff!",
                e
              );
          ...
          chatThreadClientLocalSecond =
            await chatClientUserSecond.getChatThreadClient(chatRoomId);
          try {
            ...
            try {
              ...
              chatThreadClientLocalSecond.addParticipants(
          ...
          return (
            <div
              ...
              className={`chat-message ${
                message?.metadata.userId === localStorage.getItem("userId") &&
                message?.metadata.userType === localStorage.getItem("userType")
                  ? "chat-message-user"
                  : "chat-message-bot"
              }`}
            >
