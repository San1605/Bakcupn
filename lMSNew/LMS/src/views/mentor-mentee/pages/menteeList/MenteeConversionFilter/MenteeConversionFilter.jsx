...
import "./menteeconversionfilter.css";
...
function MenteeConversionFilter({
  conversionType,
  setConversionType,
  buddyDepartment,
  setBuddyDepartment,
  ...
  const { departmentsForMentee, menteedepConversionList, dispatch } =
  ...
  const saveIt = () => {
    ...
    if (innerdepartment.length <= 0) {
      ...
      dispatch({
        ...
        payload: {
          currentPage: 1,
          buddyDepartment: innerdepartment,
          hrBuddyName: "",
          conversionType: inneremployee,
          fromDates: fromDate,
          toDates: toDate,
          conversionRangeSelect: innerConversionRangeSelect,
        },
      });
  ...
  const clearIt = () => {
    ...
    menteedepConversionList(1, departmentsForMentee.toString(), "", "", "", "");
    setBuddyDepartment([]);
    setConversionType([]);
    setConversionRangeFromMonth("");
    setConversionRangeFromYear("");
  ...
  const popoverBottom = (
    <Popover id="popover-positioned-bottom">
      <div className="filter-popover" style={{ maxHeight: "300px" }}>
        <div className="filter-head-div">
          ...
          <div className="filter-content mt-2" style={{ maxHeight: "165px" }}>
...
export default MenteeConversionFilter;
