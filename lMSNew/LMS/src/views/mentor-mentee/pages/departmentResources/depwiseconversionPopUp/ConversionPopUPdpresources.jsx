...
function ConversionPopUP({
  ...
  const { departmentlistdata, depheadConversionList, dispatch } =
  ...
  const clearIt = () => {
    ...
    depheadConversionList(1, departmentlistdata.toString(), "", "", "", "");
    setBuddyDepartment([]);
    setConversionType([]);
    setConversionRangeFromMonth("");
    setConversionRangeFromYear("");
  ...
  const popoverBottom = (
    <Popover id="popover-positioned-bottom">
      <div className="filter-popover" style={{ maxHeight: "310px" }}>
        <div className="filter-head-div">
          ...
          <div className="filter-content mt-2" style={{ maxHeight: "170px" }}>
            ...
            <div className="filter-type-content">
              {!!showDepartment && (
                <div>
                  <div
                    className="search-result overflow-y-scroll"
                    style={{ overflowY: "auto" }}
                  >
                    {!!departmentlistdata &&
                      departmentlistdata.map((val) => {
                        return (
