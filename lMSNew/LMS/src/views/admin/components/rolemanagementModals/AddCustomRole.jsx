...
function AddCustomRole() {
  ...
  const [hrtypelist, setHrtypelist] = useState([]);
  ...
  const handlesave = () => {
    if (rolename == "") {
      ...
      if (
        ...
        if (editorcheck && editordata.length == 0) {
        ...
        } else if (hrcheck && (innerhrlistdata.length == 0 || hrtypelist.length == 0)) {
          ...
          if (hrcheck) {
            const temp = {
              ...
              employeeType: hrtypelist.map((elem)=>{
                return elem.value
              })
            };
                              ...
                              return (
                                <div className="multi-name-chip" key={index}>
                                  <img
                                    ...
                                    className="userdata-searchlist-profilimg"
                                  />
                                  {/* <ImageWithFallback src={`https://storagefortimetrigger.blob.core.windows.net/profile/${
                                      elem.maile.split("@")[0]
                                    }.jpg`}
                  ...
                  >
                    ...
                    <div className="flex-input-row">
                      ...
                      <Select
                        ...
                        onChange={(e) => handlehrlist(e,"dep")}
                      />
                    </div>
                    <div className="flex-input-row mt-2">
                    <label className="singlerow-label">
                    ...
                    <Select
                      ...
                      id="manager"
                      isMulti
                      options={[{label:"Intern", value:"Intern"},{label:"Trainee", value:"Trainee"},{label:"FTE", value:"FTE"}]}
                      className="basic-multi-select w-100  multirow-select customRoleForm-multiselect"
                      classNamePrefix="multiSelect"
                      placeholder="Select Employee Type"
                      value={hrtypelist}
                      onChange={(e) => handlehrlist(e,"type")}
                    />
                  </div>
                  </>
                    )}
