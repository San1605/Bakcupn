...
function AFilterComponent(props) {
  ...
  const saveIt = () => {
    ...
    if (innerdepartment.length <= 0) {
      props.APICallingFunction(
        1,
        innerdepartment.toString(),
        capitalizeFirst(props.name),
        inneremployee,
        fromDate,
        toDate
      );
      ...
      props.APICallingFunction(
        1,
        props.APIDepartmentList.toString(),
        capitalizeFirst(props.name),
        inneremployee,
        fromDate,
        toDate
        ...
        >
          ...
          0 ? (
            <div className="filter-icon pointer">
              ...
              props.conversionRangeFromMonth.length +
              props.conversionRangeFromYear.length +
              props.conversionRangeSelect.length +
              props.conversionRangeToMonth.length +
              props.conversionRangeToYear.length >
            0 ? (
