...
function ContextComponent({ children }) {
  ...
  const [functional_requirementResp, setFunctional_requirementResp] = useState("");
  const [functional_requirementText, setFunctional_requirementText] = useState("");
  ...
  const [functional_security_requirementResp, setFunctional_security_requirementResp,] = useState("");
  const [functional_security_requirementText, setFunctional_security_requirementText,] = useState("");
  ...
  const [non_functional_requirementResp, setNon_functional_requirementResp] = useState("");
  const [non_functional_requirementText, setNon_functional_requirementText] = useState("");
  const [non_functional_security_requirementResp, setNon_functional_security_requirementResp,] = useState("");
  const [non_functional_security_requirementText, setNon_functional_security_requirementText,] = useState("");
  ...
  const [service_level_agreementResp, setService_level_agreementResp] = useState("");
  const [service_level_agreementText, setService_level_agreementText] = useState("");
  ...
  const [previewTOC,setpreviewTOC]=useState("");
