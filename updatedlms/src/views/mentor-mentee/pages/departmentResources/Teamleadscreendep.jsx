...
function Teamleadscreendep() {
    const { listteamleads, navigate, listdataofteamleads, deleteTeamlead, loading } =
            ...
            <div>
              ...
              >
                <div className="buddiePageTitle">
                  Total Resources
                  <span className="buddiesTotalCount">{listdataofteamleads ? listdataofteamleads.count : 0}</span>
                </div>
                <div className="">
                  <AddTeamLeads />
                </div>
