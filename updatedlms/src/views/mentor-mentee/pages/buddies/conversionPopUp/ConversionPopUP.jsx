...
function ConversionPopUP({
  ...
  const { comdeplist, commonconverionbigapi, convarr, dispatch } =
  ...
  const clearIt = () => {
    ...
    commonconverionbigapi(1, comdeplist.toString(), "", convarr.toString(), "", "");
    setBuddyDepartment([]);
    setConversionType([]);
    setConversionRangeFromMonth("");
    setConversionRangeFromYear("");
        ...
        <div className="filter-head-div">
          <div className="filter-pane">
            ...
            <div
              ...
              onClick={() => {setCurrentPage(1); clearIt(); }}
            >
              Clear All
            </div>
          </div>
          ...
          <div className="filter-content mt-2">
            ...
            <div className="filter-type-content">
              ...
              {showConvertionType &&
                convarr.length > 0 && convarr.map((elem) => {
                  return (
