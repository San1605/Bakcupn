  ...
  const saveIt = () => {
    ...
    if (innerdepartment.length <= 0) {
      ...
      dispatch({
        ...
        payload:{currentPage:1, buddyDepartment:innerdepartment, hrBuddyName:"", conversionType:inneremployee, fromDates:fromDate, toDates:toDate, conversionRangeSelect:innerConversionRangeSelect}
      })
