...
function MenteeList() {
  ...
  useEffect(() => {
    activeButton === 2 && menteeDepartmentList();
  }, [activeButton]);
  useEffect(() => {
    if (activeButton === 2) {
      if (
        ...
        {activeButton === 1 ? (
          <>
                ...
                onClick={() =>
                  {
                    if(reporteeView == 1)
                    {
                      exportToExcel(downloadreportalldata.alist, "Direct Mentee Report")
                    }
                    else{
                      exportToExcel(downloadreportalldata.blist, "All Mentee Report")
                    }
                  }
                }
              >
            ...
            <div className="d-flex justify-content-between align-items-center">
              ...
              {showconversion && reporteeView == 1 && <AddSecondaryMentorModal />}
            </div>
            <div
                ...
                <table class="table table-bordered fix-table">
                  <thead className="fix-thead">
                    <tr className="fix-thead-tr">
                      ...
                      {reporteeView == 1 &&<th className="fix-th nowrap">Resources</th>}
                    </tr>
                  </thead>
                    ...
                    {filtersearch.map((menteelist, index) => {
                      ...
                      return (
                        <tr className="fix-tbody-tr" key={index}>
                          ...
                          <td className="fix-td">{`${menteelist.FirstName} ${menteelist.LastName}`}</td>
                          ...
                          <td className="fix-td nowrap">
                            ...
                            {menteelist.Second_Reporting_To == null ? (
                              ...
                              <p className="w-100">
                                {menteelist.Second_Reporting_To}
                              </p>
                            )}
                          </td>
                          <td className="fix-td nowrap">
                          ...
                          {reporteeView == 1 && <td className="fix-td nowrap">
