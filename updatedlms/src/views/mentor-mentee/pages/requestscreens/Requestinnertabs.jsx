      ...
      <div className="notificationListContainer bg-white">
        ...
        <div>
          {Object.keys(requesttrigger).length > 0 ? (
            <Tabs id="controlled-tab-example" defaultActiveKey="Course-Request">
              {requesttrigger["Learning Path Request"] ? (
                <Tab
                  eventKey="Course-Request"
                  title={`Learning Path Request (${
                    menteescoursesrequest?.filter(
              ...
              {requesttrigger["Mentee Tickets"] ? (
                <Tab
                  eventKey="Mentor Tickets"
                  title={`Mentee Tickets(${
                    menteeticketlist?.filter((elem) => elem.status == 0).length
                  })`}
                >
                  {menteeticketlist ? (
              ...
              {requesttrigger["Buddy Tickets"] ? (
                <Tab
                  eventKey="Buddies Tickets"
                  title={`Buddies Tickets(${
                    budticketlist?.filter((elem) => elem.status == 0).length
                  })`}
                >
                  <div
                  ...
                  >
                    <div className="row col-12 notificationTiList">
                      {budticketlist?.length !== 0 ? (
                        ...
                        <div className="w-100 h-100 d-flex flex-column tect-center align-items-center justify-content-center">
                          <img
                            src={emptynotitable}
                            className="pe-1"
                            alt="emptynotitable"
              ...
              {requesttrigger["Conversion Request TC"] ? (
                <Tab
                  eventKey="Conversion Request TL"
                  title={`Conversion Request TC(${
                    tllist?.filter(
                      (elem) => elem.flag == true && elem.actionTaken == ""
                    ).length
                  })`}
                        ...
                        <tbody>
                          {pmlist.length > 0
                            ? pmlist.map((elem) => {
                                return (
                                  <tr className="notificationcontentrow">
                                    <td className="col-2 notificationTablecontent nowrap first-table-col ps-3">
                                      <p className="notificationContentText">
                                        {elem.employeeId}
                                      </p>
                                    </td>
