...
function InterviewSchedulerRole() {
  const { listinterviewers, navigate, interviewerlist, deleteInterviewer, loading } =
  ...
  return (
    <div className="hrbuddyContainer">
      ...
      <div className="hrbuddyListContainer bg-white">
        ...
        >
          Interview Schedular List
          <span className="hrbuddyTotalCount ms-2"> {interviewerlist ? interviewerlist.count : 0}</span>
        </div>
