...
function CourseEditor() {
  ...
  const {lpnamereleventfilter, lpnamesapi, listcourseEditor, courseedlist, deletecourseEditor, loading} = useContext(GlobalContext);
  ...
  return (
    <div className="hrbuddyContainer">
      ...
      <div className="hrbuddyListContainer bg-white">
        ...
        >
          Editor’s List
          <span className="hrbuddyTotalCount ms-2">{courseedlist ? courseedlist.count : 0}</span>
        </div>
