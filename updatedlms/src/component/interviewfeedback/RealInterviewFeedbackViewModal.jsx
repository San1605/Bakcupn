...
function RealInterviewFeedbackViewModal({ elemId, interviewtype }) {
  const { postdata, getdetailsofinterviewdata } = useContext(GlobalContext);
  const [reportshow, setReportshow] = useState(false);
  const [prlist, setPrlist] = useState([]);
  const channel = [1, 2, 3, 4, 5];
  useEffect(() => {
    if (reportshow) {
      getdetailsofinterviewdata(elemId);
    }
  }, [reportshow]);
  // useEffect(()=>{
  //   if(reportshow)
                ...
                <div className="rating-card-counts">
                  {channel.map((elem) => {
                    return (
                      <div
                        className={
                          postdata?.communicationScore == elem
                ...
                <div className="rating-card-counts">
                  {channel.map((elem) => {
                    return (
                      <div
                        className={
                          postdata?.learningAdaptibility == elem
                            ? "countonclick blocked-input"
                            : "count-block count-block-view"
                        }
                      >
                ...
                <div className="rating-card-counts">
                  <div className="performenceRadioBtnContainer d-flex">
                    <input
                      ...
                      value="yes"
                      checked={
                        postdata?.isResumeUpdated?.toLowerCase() === "yes"
                      }
                    />
                  ...
                  <div className="performenceRadioBtnContainer d-flex">
                    <input
                      ...
                      value="no"
                      checked={
                        postdata?.isResumeUpdated?.toLowerCase() === "no"
                      }
                    />
            ...
            <div className="ratePerformanceContainer d-flex flex-column">
              ...
              <div className="performanceOptions d-flex flex-column gap-2">
                ...
                Qualified Successfully)"
                    style={{ marginTop: "4px" }}
                    checked={postdata?.finalVerdict?.split(" ")[0] == "Concern"}
                  />
                ...
                getting deployed on a project."
                    checked={
                      postdata?.finalVerdict?.split(" ")[0] == "Interview"
                    }
                  />
                ...
                <div className="performenceRadioBtnContainer d-flex">
                  <input
                    ...
                    checked={postdata?.finalVerdict?.split(" ")[0] == "Need"}
                  />
              ...
              <div className="performanceOptions d-flex flex-col">
                <div className="performenceRadioBtnContainer d-flex">
                  <input
                    type="radio"
                    name="performance"
                    checked={postdata?.overallPerformance === "Excellent"}
                    id="excellent"
                    disabled
                    className="inputRadio pt-1"
                    value="Excellent"
                ...
                <div className="performenceRadioBtnContainer d-flex">
                  <input
                    type="radio"
                    name="performance"
                    checked={postdata?.overallPerformance === "Good"}
                    disabled
                    className="inputRadio pt-1"
                    id="good"
                    value="Good"
                ...
                <div className="performenceRadioBtnContainer d-flex">
                  <input
                    type="radio"
                    name="performance"
                    checked={postdata?.overallPerformance === "Above Average"}
                    disabled
                    className="inputRadio pt-1"
                    id="average"
                    value="Above Average"
                ...
                <div className="performenceRadioBtnContainer d-flex">
                  <input
                    type="radio"
                    name="performance"
                    checked={postdata?.overallPerformance === "Poor"}
                    disabled
                    className="inputRadio pt-1"
                    id="Poor"
                    value="Poor"
                ...
                <div className="performenceRadioBtnContainer d-flex">
                  <input
                    type="radio"
                    name="performance"
                    checked={postdata?.overallPerformance === "PIP"}
                    disabled
                    className="inputRadio pt-1"
                    id="PIP"
                    value="PIP"
            ...
            <div className="ratePerformanceContainer d-flex flex-column">
              ...
              <div className="performanceOptions d-flex">
                <input
                  ...
                  value={postdata?.strengthInTechnical}
                  disabled
                />
              </div>
            </div>
            <div className="ratePerformanceContainer d-flex flex-column">
              ...
              <div className="performanceOptions d-flex">
                <input
                  ...
                  id="feedback"
                  className="w-100 rounded py-1 px-2 viewfeedback-input"
                  value={postdata?.weaknessInTechnical}
                  disabled
                />
              </div>
            </div>
            <div className="ratePerformanceContainer d-flex flex-column">
              ...
              <div className="performanceOptions d-flex">
                <textarea
                  id="feedback"
                  className="w-100 rounded py-1 px-2 viewfeedback-input"
                  value={postdata?.improvementArea}
                  disabled
                />
              </div>
            </div>
                  ...
                  <div className="performanceOptions d-flex flex-col">
                    <div className="performenceRadioBtnContainer d-flex">
                      <input
                        ...
                        className="inputRadio pt-1"
                        value="Yes"
                        checked={postdata?.celigible?.toLowerCase() === "yes"}
                        disabled
                      />
                      <label htmlFor="Yes" className="radioBtnLabel">
                        Yes
                    ...
                    <div className="performenceRadioBtnContainer d-flex">
                      <input
                        ...
                        id="no"
                        value="no"
                        checked={postdata?.celigible?.toLowerCase() === "no"}
                        disabled
                      />
                      <label htmlFor="no" className="radioBtnLabel">
                        No
...
export default RealInterviewFeedbackViewModal;
