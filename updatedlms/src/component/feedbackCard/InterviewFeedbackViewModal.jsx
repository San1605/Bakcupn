...
function InterviewFeedbackViewModal(props) {
  useEffect(() => {
    ...
    <div className="viewinterviewfeedback">
      ...
      >
        <Modal.Header className="infoModalHead">
          <Modal.Title>{`${props.modalinfo.interviewTitle}`} Feedback View</Modal.Title>
          <CloseButton
            style={{ fontSize: "12px" }}
            variant="white"
            onClick={() => setReportshow(!reportshow)}
        ...
        >
          <div className="px-2 d-flex flex-column feedbackFormContainer">
                ...
                <div className="rating-card-counts">
                  <div className="performenceRadioBtnContainer d-flex">
                    <input
                      ...
                      value="yes"
                      checked={
                        props.modalinfo.isResumeUpdated.toLowerCase() === "yes"
                      }
                    />
                  ...
                  <div className="performenceRadioBtnContainer d-flex">
                    <input
                      ...
                      value="no"
                      checked={
                        props.modalinfo.isResumeUpdated.toLowerCase() === "no"
                      }
                    />
              ...
              <div className="performanceOptions d-flex flex-col">
                <div className="performenceRadioBtnContainer d-flex">
                  <input
                    type="radio"
                    name="performance"
                    checked={props.modalinfo.overallPerformance === "Excellent"}
                    id="excellent"
                    disabled
                    className="inputRadio pt-1"
                    value="Excellent"
            ...
            {props.modalinfo.interviewTitle !== "Monthly" ? (
              <div className="ratePerformanceContainer d-flex flex-column">
                <div className="ratePerformanceHead">
                  <p>
                ...
                <div className="performanceOptions d-flex">
                  <textarea
                    ...
                    value={props.modalinfo.cprojectList}
                    disabled
                  />
                </div>
              </div>
                ...
                <div className="ratePerformanceContainer d-flex flex-column">
                  ...
                  <div className="performanceOptions d-flex">
                    <input
                      ...
                      placeholder="Eg. **************@gmail.com"
                      value={props?.modalinfo?.cdecisionMaker}
                      disabled
                    />
                  </div>
                </div>
                  ...
                  <div className="performanceOptions d-flex flex-col">
                    <div className="performenceRadioBtnContainer d-flex">
                      <input
                        ...
                        value="Yes"
                        checked={
                          props?.modalinfo?.celigible?.toLowerCase() === "yes"
                        }
                        disabled
                      />
                      <label htmlFor="Yes" className="radioBtnLabel">
                    ...
                    <div className="performenceRadioBtnContainer d-flex">
                      <input
                        ...
                        value="no"
                        checked={
                          props?.modalinfo?.celigible?.toLowerCase() === "no"
                        }
                        disabled
                      />
                      <label htmlFor="no" className="radioBtnLabel">
            ...
            <div className="ratePerformanceContainer d-flex flex-column">
              ...
              <div className="performanceOptions d-flex flex-column gap-2">
                ...
                getting deployed on a project."
                    checked={
                      props.modalinfo.finalVerdict.split(" ")[0] == "Interview"
                    }
                  />
...
export default InterviewFeedbackViewModal;
