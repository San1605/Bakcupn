...
export const GlobalProvider = ({ children }) => {
  ...
  //       payload: io('https://6abb-103-137-84-126.ngrok-free.app/', {
  ...
  //   })
    ...
    state.socket.on("connect", () => {
      console.log(state.socket, "socket.id", state.socket.id);
      });
  ...
  async function allTickets() {
    const response = await fetch(
      `${process.env.REACT_APP_API_URL}/api/tickets/getTicketsInfo`,
      cheaders
    );
  ...
  async function getMyCourse() {
    const response = await fetch(
      `${process.env.REACT_APP_API_URL}/api/courses/myCourses`,
      cheaders
    );
  ...
  async function getSamplerFile() {
    const response = await fetch(
      `${process.env.REACT_APP_API_URL}/api/samplers/download`,
      cheaders
    );
  ...
  async function getTechnogoies() {
    const response = await fetch(
      `${process.env.REACT_APP_API_URL}/api/courses/listTechnologies`,
      cheaders
    );
  ...
  async function getCourseCompletionNumber() {
    const response = await fetch(
      `${process.env.REACT_APP_API_URL}/api/courses/courseCompletionStatus`,
      cheaders
    );
  ...
  async function getTicketStatusInfo() {
    const response = await fetch(
      `${process.env.REACT_APP_API_URL}/api/tickets/getStatus`,
      cheaders
    );
  ...
  async function getAllCourses(pageno, tech) {
    const response = await axios.get(
      `${process.env.REACT_APP_API_URL}/api/courses/getAllCourses?technology=&pageNumber=${pageno}&limit=10`,
      cheaders
    );
  ...
  async function getLeaderBoard() {
    const response = await fetch(
      `${process.env.REACT_APP_API_URL}/api/courses/leaderboard`,
      cheaders
    );
  ...
  async function gethrmusingzoho(token) {
    ...
    const response = await fetch(
      `${process.env.REACT_APP_API_URL}/api/notification/hrmFromEmail`,
      {
        headers: {
  ...
  async function rolecheck(hrm) {
    const response = await fetch(
      `${process.env.REACT_APP_API_URL}/api/mentor/mentorMenteeDifference?HRMID=${hrm}`
    );
  ...
  async function enrollCourse(courseId, courseName) {
    ...
    const response = await fetch(
      `${process.env.REACT_APP_API_URL}/api/courses/enroll`,
      {
        headers: {
          Accept: "application/json",
          "Content-Type": "application/json",
  ...
  async function courseDataById(courseId) {
    const response = await fetch(
      `${process.env.REACT_APP_API_URL}/api/courses/getACourseDetail?courseId=${courseId}`,
      cheaders
    );
  ...
  async function getNotes(found) {
    ...
    const response = await fetch(
      `${process.env.REACT_APP_API_URL}/api/notes/getNotes?courseId=${state.notes.courseId
      }&topic=${found
  ...
  async function addNotes() {
    ...
    const response = await fetch(
      `${process.env.REACT_APP_API_URL}/api/notes/addNotes`,
      {
        headers: {
          Accept: "application/json",
          "Content-Type": "application/json",
  ...
  async function posttimeofstartingcourse(coursedata) {
    ...
    const response = await fetch(
      `${process.env.REACT_APP_API_URL}/api/courses/currentprogress`,
      {
        headers: {
          Accept: "application/json",
          "Content-Type": "application/json",
  ...
  async function getmycurrentcourse(IdofCourse) {
    ...
    const response = await fetch(
      `${process.env.REACT_APP_API_URL}/api/courses/getACourseDetailEnrolled?courseId=${IdofCourse}`,
      cheaders
    );
    let enrolledcourse = await response.json();
    if (response.status === 200) {
  ...
  async function startofcoursefromlasttime(courseiD, enrolled) {
    const response = await fetch(
      `${process.env.REACT_APP_API_URL}/api/courses/getLastSubtopicTime?courseCode=${courseiD}`,
      cheaders
    );
  ...
  async function putupdateofcurrentcourse(course_ID) {
    ...
    const response = await fetch(
      `${process.env.REACT_APP_API_URL}/api/courses/updateSubtopicTime?courseCode=${course_ID}`,
      {
        headers: {
          Accept: "application/json",
          "Content-Type": "application/json",
  ...
  async function updateoftimefromlasttime(course_ID) {
    ...
    const response = await fetch(
      `${process.env.REACT_APP_API_URL}/api/courses/updateSubtopicTimeLatest?courseCode=${course_ID}`,
      {
        headers: {
          Accept: "application/json",
          "Content-Type": "application/json",
  ...
  async function getallpath(pageno, dep, searched) {
    ...
    const response = await fetch(
      `${process.env.REACT_APP_API_URL}/api/learningPath/getAllLps?pageNumber=${pageno}&lpName=${searched}`,
      {
        headers: {
          Accept: "application/json",
          "Content-Type": "application/json",
  ...
  async function getsingleunenrolledpath(pathname) {
    const response = await fetch(
      `${process.env.REACT_APP_API_URL}/api/learningPath/getALpDetail?lp=${pathname}`,
      cheaders
    );
  ...
  async function enrollPath(pathname) {
    const toastId = toast.loading("Please wait...");
    const response = await fetch(
      `${process.env.REACT_APP_API_URL}/api/learningPath/enroll?lp=${pathname}`,
      {
        headers: {
          Accept: "application/json",
          "Content-Type": "application/json",
  ...
  async function getallpathindashboard() {
    const response = await fetch(
      `${process.env.REACT_APP_API_URL}/api/learningPath/listLearningPath`,
      cheaders
    );
  ...
  async function getallmenteelist() {
    ...
    const response = await fetch(
      `${process.env.REACT_APP_API_URL}/api/mentor/menteeDetails?emailId=${email}`,
      cheaders
    );
  ...
  async function getallfullmenteelist() {
    const response = await fetch(
      `${process.env.REACT_APP_API_URL}/api/mentor/hierarchyMenteeList`,
      cheaders
    );
    const menteeslist = await response.json();
    if (response.status === 200) {
  ...
  async function getallmenteelistforeach(mail) {
    ...
    const response = await fetch(
      `${process.env.REACT_APP_API_URL}/api/mentor/menteeDetails?emailId=${mail}`,
      cheaders
    );
    const menteeslist = await response.json();
    if (response.status === 200) {
  ...
  async function getallmenteelistvalidation(pervalid) {
    const response = await fetch(
      `${process.env.REACT_APP_API_URL}/api/mentor/menteeDetails?HRMID=${state.hrm_id}`,
      cheaders
    );
    const menteeslist = await response.json();
    if (response.status === 200) {
  ...
  async function getprofiledata() {
    const response1 = await fetch(
      `${process.env.REACT_APP_API_URL}/api/mentor/profileDetails`,
      cheaders
    );
  ...
  async function getprofileengagement(){
    const response = await fetch(
      `${process.env.REACT_APP_API_URL}/api/profile/getProjectAndCertificationDetail`,
      cheaders
    );
  ...
  async function uploadcertificate(uploadingcertificate) {
    ...
    try {
      const response = await axios.post(
        `${process.env.REACT_APP_API_URL}/api/profile/uploadCertificate`,
        bodyFormData,
        {
          headers: {
  ...
  async function deletecertificate(cerid){
    ...
    try{
      const response = await fetch(
        `${process.env.REACT_APP_API_URL}/api/profile/deleteUploadedCertificate`,
        {
          headers: {
            Accept: "application/json",
            "Content-Type": "application/json",
  ...
  async function getmenteescourserequest() {
    const response = await fetch(
      `${process.env.REACT_APP_API_URL}/api/mentor/courseRequest?HRMID=${state.hrm_id}`,
      cheaders
    );
  ...
  async function updatecourserequest(
    ...
    const response = await fetch(
      `${process.env.REACT_APP_API_URL}/api/learningPath/approveCourse?lp=${lp}&emailId=${menteemail}`,
      {
        headers: {
          Accept: "application/json",
          "Content-Type": "application/json",
  ...
  async function ticketdataofemployee() {
    const response = await fetch(
      `${process.env.REACT_APP_API_URL}/api/mentor/ticketRequest?HRMID=${state.hrm_id}`,
      cheaders
    );
  ...
  async function updateticketrequest(
    ...
    const response = await fetch(
      `${process.env.REACT_APP_API_URL}/api/tickets/updateStatus?emailId=${mail}&createdDate=${date}`,
      {
        headers: {
          Accept: "application/json",
          "Content-Type": "application/json",
  ...
  async function hrbuddylist() {
    const response = await fetch(
      `${process.env.REACT_APP_API_URL}/api/hrbuddy/buddyLists?HRMID=${state.hrm_id}`,
      cheaders
    );
    ...
    if (response.status === 200) {
      dispatch({
        type: "BUDDY_LIST",
        payload: buddyresponse.data.result,
      });
      dispatch({
        type: "DEPARTMENT_BUDDY",
        payload: buddyresponse.data.distinctDepartment,
      });
    } else {
      console.error();
    }
  ...
  async function menteedetailsforview(email) {
    const response1 = await fetch(
      `${process.env.REACT_APP_API_URL}/api/mentor/menteeProfileDetails?emailId=${email}@celebaltech.com`,
      cheaders
    );
  ...
  async function lpformenteereport(mail) {
    const response = await fetch(
      `${process.env.REACT_APP_API_URL}/api/mentor/listMenteeLps?emailId=${mail}@celebaltech.com`,
      cheaders
    );
  ...
  async function ticketformenteereport(mail) {
    const response = await fetch(
      `${process.env.REACT_APP_API_URL}/api/mentor/getMenteeTicketStatus?emailId=${mail}@celebaltech.com&HRMID=${state.hrm_id}`,
      cheaders
    );
  ...
  async function coursestatusofmentee(mail, year, month) {
    const response = await fetch(
      `${process.env.REACT_APP_API_URL}/api/mentor/menteeEnrolledCourse?emailId=${mail}@celebaltech.com&year=${year}&month=${month}`,
      cheaders
    );
  ...
  async function uploadtaskofmentee(uploadintask, email) {
    ...
    try {
      const response = await axios.post(
        `${process.env.REACT_APP_API_URL}/api/mentor/interviewReport?emailId=${email}@celebaltech.com`,
        bodyFormDataReport,
        {
          headers: {
            "Content-Type": "multipart/form-data",
  ...
  async function postdetailsoffeedbackreport(email, feedbackform) {
    ...
    try {
      const response = await fetch(
        `${process.env.REACT_APP_API_URL}/api/mentor/menteeFeedbackReport?emailId=${email}@celebaltech.com`,
        {
          headers: {
            Accept: "application/json",
            "Content-Type": "application/json",
  ...
  async function updatedetailsoffeedbackreport(feedbackform) {
    ...
    try {
      const response = await fetch(
        `${process.env.REACT_APP_API_URL}/api/mentor/updateMenteeFeedbackReport`,
        {
          headers: {
            Accept: "application/json",
            "Content-Type": "application/json",
  ...
  //   const response = await fetch(
  //     `${process.env.REACT_APP_API_URL}/api/mentor/listMenteeInterviewReports?emailId=${email}@celebaltech.com`,
  //     cheaders
  //   );
  ...
  async function getfeedbackofmentee(email) {
    const response = await fetch(
      `${process.env.REACT_APP_API_URL}/api/mentor/getMenteeFeedbackReport?emailId=${email}@celebaltech.com`,
      cheaders
    );
  ...
  async function updateprofiledata(somedata) {
    ...
    try {
      const response = await fetch(
        `${process.env.REACT_APP_API_URL}/api/mentor/updateProfileDetail`,
        {
          headers: {
            Accept: "application/json",
            "Content-Type": "application/json",
  ...
  async function menteenotification() {
    const response = await fetch(
      `${process.env.REACT_APP_API_URL}/api/notification/notifies?HRMID=${state.hrm_id}`,
      cheaders
    );
  ...
  async function sendtoperson(person) {
    const response = await fetch(
      `${process.env.REACT_APP_API_URL}/api/tickets/dropdownReasonPerson?concernedPerson=${person}`,
      cheaders
    );
  ...
  async function firsttimelogin() {
    const response = await fetch(
      `${process.env.REACT_APP_API_URL}/api/mentor/firstTimeLogin`,
      cheaders
    );
  ...
  async function buddiestickets() {
    const response = await fetch(
      `${process.env.REACT_APP_API_URL}/api/hrbuddy/ticketRequestsBuddy?HRMID=${state.hrm_id}`,
      cheaders
    );
  ...
  async function updatebuddieticketrequest(
    ...
    const response = await fetch(
      `${process.env.REACT_APP_API_URL}/api/hrbuddy/updateTicketStatus?emailId=${mail}&createdDate=${date}`,
      {
        headers: {
          Accept: "application/json",
          "Content-Type": "application/json",
  ...
  async function getlistofcoursemanager() {
    const response = await fetch(
      `${process.env.REACT_APP_API_URL}/api/courses/courseManager`,
      cheaders
    );
  ...
  async function geteachassigner(personmail) {
    const response = await fetch(
      `${process.env.REACT_APP_API_URL}/api/mentor/getSecondaryMentorList?HRMID=${state.hrm_id}&emailId=${personmail}`,
      cheaders
    );
  ...
  async function getallassigner() {
    const response = await fetch(
      `${process.env.REACT_APP_API_URL}/api/mentor/secondaryMentorCount?HRMID=${state.hrm_id}`,
      cheaders
    );
  ...
  async function secondmentor(secondlist) {
    const response = await fetch(
      `${process.env.REACT_APP_API_URL}/api/mentor/assignSecondaryMentor`,
      {
        headers: {
          Accept: "application/json",
          "Content-Type": "application/json",
  ...
  async function freementor() {
    const response = await fetch(
      `${process.env.REACT_APP_API_URL}/api/mentor/getFreeMentees?HRMID=${state.hrm_id}`,
      cheaders
    );
  ...
  async function allrequestexit(batchhere) {
    const response = await fetch(
      `${process.env.REACT_APP_API_URL}/api/courses/coursePauseResume`,
      {
        headers: {
          Accept: "application/json",
          "Content-Type": "application/json",
  ...
  async function runrequest(lpstack) {
    ...
    const response = await fetch(
      `${process.env.REACT_APP_API_URL}/api/courses/courseRunState`,
      {
        headers: {
          Accept: "application/json",
          "Content-Type": "application/json",
  ...
  // async function pmtc() {
  //   const response = await fetch(
  //     `${process.env.REACT_APP_API_URL}/api/conversion/isPmTc`,
  //     cheaders
  //   );
  ...
  async function conversionmentor(menteemail) {
    ...
    const response = await fetch(
      `${process.env.REACT_APP_API_URL}/api/conversion/menteeConversionRequest?emailId=${menteemail}@celebaltech.com`,
      cheaders
    );
  ...
  async function pmrequest() {
    const response = await fetch(
      `${process.env.REACT_APP_API_URL}/api/conversion/projectManagerRequest`,
      cheaders
    );
  ...
  async function tlrequest() {
    const response = await fetch(
      `${process.env.REACT_APP_API_URL}/api/conversion/teamCoordinatorRequest`,
      cheaders
    );
  ...
  async function projectlistofper(mailh) {
    const response = await fetch(
      `${process.env.REACT_APP_API_URL}/api/conversion/projectList?emailId=${mailh}@celebaltech.com`,
      cheaders
    );
  ...
  async function actionoftl(id, act) {
    ...
    try {
      const response = await fetch(
        `${process.env.REACT_APP_API_URL}/api/conversion/teamCoordinatorAction`,
        {
          headers: {
            Accept: "application/json",
            "Content-Type": "application/json",
  ...
  async function formofpm(fm) {
    ...
    try {
      const response = await fetch(
        `${process.env.REACT_APP_API_URL}/api/conversion/projectManagerForm`,
        {
          headers: {
            Accept: "application/json",
            "Content-Type": "application/json",
  ...
  async function downloadreportall() {
    const response = await fetch(
      `${process.env.REACT_APP_API_URL}/api/mentor/downloadMenteeReport?HRMID=${state.hrm_id}&emailId=${state.userMail}`,
      cheaders
    );
    const resofreportall = await response.json();
    if (response.status == 200) {
      dispatch({
        type: "DOWNREPORTALL_1",
        payload: resofreportall.data,
      });
    }
  }
  async function downloadreportallfull() {
    const response = await fetch(
      `${process.env.REACT_APP_API_URL}/api/mentor/downloadAllHierarchyMenteeReport`,
      cheaders
    );
    const resofreportall = await response.json();
    if (response.status == 200) {
      dispatch({
        type: "DOWNREPORTALL_2",
        payload: resofreportall.data,
      });
    }
  }
  async function reportforeach(passingone) {
    const response = await fetch(
      `${process.env.REACT_APP_API_URL}/api/conversion/downloadMenteeConversionForm?emailId=${passingone}@celebaltech.com`,
      cheaders
    );
  ...
  async function downloadsingleonlyfn(prone, interviewsId) {
    const response = await fetch(
      `${process.env.REACT_APP_API_URL}/api/conversion/downloadMenteesSingleConversionForm?emailId=${prone}@celebaltech.com&interviewId=${interviewsId}`,
      cheaders
    );
    const getreporter = await response.json();
    if (response.status == 200) {
  ...
  async function downloadreportforhr(
    department,
    name,
    type,
    from,
    ...
    const response = await fetch(
      `${process.env.REACT_APP_API_URL}/api/hrbuddy/downloadHrConversionDetail?from=${from ? from : ""
  ...
  async function downloadreportforhrsimple() {
    const response = await fetch(
      `${process.env.REACT_APP_API_URL}/api/hrbuddy/downloadBuddyList?emailId=${state.userMail}`,
      cheaders
    );
  ...
  async function havenav() {
    const response = await fetch(
      `${process.env.REACT_APP_API_URL}/api/role/navbar`,
      cheaders
    );
  ...
  async function convtype() {
    const response = await fetch(
      `${process.env.REACT_APP_API_URL}/api/conversion/conversionCheckersAuthorityList`,
      cheaders
    );
  ...
  async function commonconverionbigapi(
    page,
    department,
    name,
    type,
    ...
    const response = await fetch(
      `${process.env.REACT_APP_API_URL}/api/conversion/listConversionMonthDetailForChecker?from=${from ? from : ""
      }&to=${to ? to : ""}&conversionType=${type ? type : ""}&name=${name ? name : ""
      }&pageNumber=${page}`,
      {
        headers: {
  ...
  async function getavailableschedule(data){
    const response = await fetch(
      `${process.env.REACT_APP_API_URL}/api/interview/getAvailableSchedule`,
      {
        headers: {
          Accept: "application/json",
          "Content-Type": "application/json",
  ...
  async function interviewlistdata(data){
    ...
    try{
    const response = await fetch(
      `${process.env.REACT_APP_API_URL}/api/interview/scheduledInterviewsDb`,
      {
        headers: {
          Accept: "application/json",
          "Content-Type": "application/json",
  ...
  async function checkadmin(tokken, admintry) {
    const response = await fetch(
      `${process.env.REACT_APP_API_URL}/api/admin/isAdmin`,
      {
        headers: {
          Authorization: `Bearer ${tokken}`,
        },
  ...
  async function uploadcourse(uploadingcourse, passon) {
    ...
    try {
      const response = await axios.post(
        `${process.env.REACT_APP_API_URL}/api/admin/addCourse`,
        bodyFormData,
        {
          headers: {
            "Content-Type": "multipart/form-data",
  ...
  async function lpcreate(lpname) {
    ...
    try {
      const response = await axios.post(
        `${process.env.REACT_APP_API_URL}/api/admin/createLp`,
  ...
  async function lplistforlpm() {
    const response = await fetch(
      `${process.env.REACT_APP_API_URL}/api/courses/departmentOfLearningPathManagement`,
      cheaders
    );
  ...
  async function admindashdata(pageno, name, dep, emp, eml) {
    const sender = {
      name: name,
      department: dep,
      employeeType: emp,
    ...
    try {
      const response = await fetch(
        `${process.env.REACT_APP_API_URL}/api/admin/adminDashboard?pageNumber=${pageno}`,
        {
          headers: {
            Accept: "application/json",
            "Content-Type": "application/json",
  ...
  async function admindashline() {
    const response = await fetch(
      `${process.env.REACT_APP_API_URL}/api/admin/dashboardDepartmentAdmin`,
      cheaders
    );
  ...
  const departmentlist = async () => {
    const response = await fetch(
      `${process.env.REACT_APP_API_URL}/api/admin/listDistinctDepartment`,
      cheaders
    );
  ...
  const departmentlistforhrselect = async () => {
    const response = await fetch(
      `${process.env.REACT_APP_API_URL}/api/hrbuddy/listInternTraineeDepartment`,
      cheaders
    );
    const departmentdata = await response.json();
    if (response.status == 200) {
  ...
  async function newadmincreate(adminemail) {
    ...
    try {
      const response = await fetch(
        `${process.env.REACT_APP_API_URL}/api/admin/createAdmin`,
        {
          headers: {
            Accept: "application/json",
            "Content-Type": "application/json",
  ...
  async function newhrbuddycreate(hrbuddy) {
    ...
    try {
      const response = await fetch(
        `${process.env.REACT_APP_API_URL}/api/hrbuddy/createHrbuddy`,
        {
          headers: {
            Accept: "application/json",
            "Content-Type": "application/json",
  ...
  async function newcoursemanager(coursemanager) {
    ...
    try {
      const response = await fetch(
        `${process.env.REACT_APP_API_URL}/api/admin/addLpManager`,
        {
          headers: {
            Accept: "application/json",
            "Content-Type": "application/json",
  ...
  //   const response = await fetch(
  //     `${process.env.REACT_APP_API_URL}/api/learningPath/listAllLpFromDbs`,
  //     cheaders
  //   )
  //   const lpdata = await response.json();
  //   if(response.status === 200)
  ...
  async function lpfordep(dep) {
    ...
    const response = await fetch(
      `${process.env.REACT_APP_API_URL}/api/admin/listLpsOfDepartment`,
      {
        headers: {
          Accept: "application/json",
          "Content-Type": "application/json",
  ...
  async function learningpathmanagerlist(pageno, searched) {
    ...
    try{
    const response = await fetch(
      `${process.env.REACT_APP_API_URL}/api/admin/listCourseManager?pageNumber=${pageno}&firstName=${searched}`,
      cheaders
    );
  ...
  async function generalfilesadd(file) {
    ...
    try {
      const response = await axios.post(
        `${process.env.REACT_APP_API_URL}/api/samplers/upload`,
  ...
  async function deletemanager(mail, lp) {
    ...
    try {
      const response = await fetch(
        `${process.env.REACT_APP_API_URL}/api/admin/deleteLpManager?emailId=${mail}&learningPath=${lp}`,
        {
          headers: {
            Accept: "application/json",
            "Content-Type": "application/json",
  ...
  async function listadmin(pageno, namer) {
    ...
    try{
    const response = await fetch(
      `${process.env.REACT_APP_API_URL}/api/admin/listAdmin?pageNumber=${pageno}&name=${namer}`,
      cheaders
    );
  ...
  async function deleteAdmin(roledata) {
    ...
    try {
      const response = await fetch(
        `${process.env.REACT_APP_API_URL}/api/admin/deleteAdmin`,
        {
          headers: {
            Accept: "application/json",
            "Content-Type": "application/json",
  ...
  async function listHr(pageno, namer, dep) {
    ...
    try{
    const response = await fetch(
      `${process.env.REACT_APP_API_URL}/api/admin/listHr?pageNumber=${pageno}&name=${namer}`,
      {
        headers: {
          Accept: "application/json",
          "Content-Type": "application/json",
  ...
  async function deleteHr(submit) {
    ...
    try {
      const response = await fetch(
        `${process.env.REACT_APP_API_URL}/api/admin/deleteHr`,
        {
          headers: {
            Accept: "application/json",
            "Content-Type": "application/json",
      ...
      if (response.status == 200) {
        ...
        if(submit.state !== 0)
        {
          ...
          toast.success(`Hr access has been revoked from ${submit.department} department`);
        } 
      }
  ...
  async function allcoursesinadmin(lpname) {
    try {
      const response = await fetch(
        `${process.env.REACT_APP_API_URL}/api/learningPath/getALpDetailRoleBase?lp=${lpname}`,
        cheaders
      );
  ...
  async function admindashgraph() {
    const response = await fetch(
      `${process.env.REACT_APP_API_URL}/api/admin/dashboardCard`,
      cheaders
    );
  ...
  async function adminhrinnerlist(dep, personmail) {
    ...
    const response = await fetch(
      `${process.env.REACT_APP_API_URL}/api/hrbuddy/buddiesOfDepartment`,
      {
        headers: {
          Accept: "application/json",
          "Content-Type": "application/json",
  ...
  async function AdminDashboardDataAnalytics(require_pramas) {
    ...
    try {
      const response = await fetch(
        `${process.env.REACT_APP_API_URL}/api/admin/adminDashboardDataAnalytics`,
        {
          headers: {
            Accept: "application/json",
            "Content-Type": "application/json",
  ...
  async function AdminDashboardDataSelect(require_pramas) {
    try {
      const response = await fetch(
        `${process.env.REACT_APP_API_URL}/api/admin/listMentorOfDepartment`,
        {
          headers: {
            Accept: "application/json",
            "Content-Type": "application/json",
      ...
      if (response.status === 200) {
        dispatch({
          ...
          payload: admin_department_select.data,
        });
      }
    } catch (error) {
      console.log(error);
  ...
  async function rolecheckregular() {
    const response = await fetch(
      `${process.env.REACT_APP_API_URL}/api/mentor/mentorMenteeDifference?HRMID=${state.hrm_id}`
    );
    const checker = await response.json();
    if (response.status === 200) {
      localStorage.setItem("role", checker.data.status);
  ...
  async function hrBuddiesConversionList(
    ...
    const response = await fetch(
      `${process.env.REACT_APP_API_URL}/api/hrbuddy/hrConversionDetails?from=${from ? from : ""
      }&to=${to ? to : ""}&conversionType=${type ? type : ""}&name=${name ? name : ""
      }&pageNumber=${page}`,
      {
        headers: {
  ...
  async function hrBuddiesDepartmentList() {
    const response = await fetch(
      `${process.env.REACT_APP_API_URL}/api/hrbuddy/departmentsForHr`,
      {
        headers: {
          Authorization: `Bearer ${state.userToken}`,
        },
    ...
    if (response.status === 200) {
      dispatch({
        ...
        payload: hrbuddydepartmentlist.data,
      });
    } else {
      console.error();
    }
  ...
  async function menteeDepartmentList() {
    const response = await fetch(
      `${process.env.REACT_APP_API_URL}/api/mentor/departmentsForMentor`,
      {
        headers: {
          Authorization: `Bearer ${state.userToken}`,
        },
  ...
  async function requestdata() {
    const response = await fetch(
      `${process.env.REACT_APP_API_URL}/api/role/requestInsight`,
      cheaders
    );
  ...
  async function listdephead(pageno, namer, dep) {
    ...
    try{
    const response = await fetch(
      `${process.env.REACT_APP_API_URL}/api/admin/listDepartmentHead?pageNumber=${pageno}&name=${namer}`,
      {
        headers: {
          Accept: "application/json",
          "Content-Type": "application/json",
  ...
  async function deletedephead(submit) {
    ...
    try {
      const response = await fetch(
        `${process.env.REACT_APP_API_URL}/api/admin/deleteDepartmentHead`,
        {
          headers: {
            Accept: "application/json",
            "Content-Type": "application/json",
      ...
      if (response.status == 200) {
        ...
        if(submit.state !== 0)
        {
          ...
          toast.success(`Department head's access has been revoked from ${submit.department} department`);
        }
  ...
  async function newheadofdepcreate(depheadatta) {
    ...
    try {
      const response = await fetch(
        `${process.env.REACT_APP_API_URL}/api/admin/addDepartmentHead`,
        {
          headers: {
            Accept: "application/json",
            "Content-Type": "application/json",
  ...
  async function listlpadmin(pageno, namer) {
    ...
    try{
    const response = await fetch(
      `${process.env.REACT_APP_API_URL}/api/admin/listLpAdmin?pageNumber=${pageno}&name=${namer}`,
      cheaders
    );
    const lists = await response.json();
    if (response.status == 200) {
  ...
  async function deletelpAdmin(roledata) {
    ...
    try {
      const response = await fetch(
        `${process.env.REACT_APP_API_URL}/api/admin/deleteLpAdmin`,
        {
          headers: {
            Accept: "application/json",
            "Content-Type": "application/json",
  ...
  async function newlpadmincreate(adminemail) {
    ...
    try {
      const response = await fetch(
        `${process.env.REACT_APP_API_URL}/api/admin/addLpAdmin`,
        {
          headers: {
            Accept: "application/json",
            "Content-Type": "application/json",
  ...
  async function lpnamesapi() {
    const response = await fetch(
      `${process.env.REACT_APP_API_URL}/api/learningPath/existingLpList`,
      cheaders
    );
  ...
  async function listcourseEditor(pageno, namer, learningPath) {
    ...
    try{
    const response = await fetch(
      `${process.env.REACT_APP_API_URL}/api/admin/listCourseEditor?pageNumber=${pageno}&name=${namer}&learningPath=${learningPath}`,
      cheaders
    );
  ...
  async function newcourseeditorcreate(adminemail) {
    ...
    try {
      const response = await fetch(
        `${process.env.REACT_APP_API_URL}/api/admin/addCourseEditor`,
        {
          headers: {
            Accept: "application/json",
            "Content-Type": "application/json",
  ...
  async function deletecourseEditor(roledata) {
    ...
    try {
      const response = await fetch(
        `${process.env.REACT_APP_API_URL}/api/admin/deleteCourseEditor`,
        {
          headers: {
            Accept: "application/json",
            "Content-Type": "application/json",
      ...
      if (response.status == 200) {
        ...
        if(roledata.state !== 0)
        {
          ...
          toast.success(`Course Editor access has been revoked from ${roledata.courseId} course successfully`);
        }
      }
  ...
  async function listCourseReviewer(pageno, namer, learningPath) {
    ...
    try{
    const response = await fetch(
      `${process.env.REACT_APP_API_URL}/api/admin/listCourseReviewer?pageNumber=${pageno}&name=${namer}&learningPath=${learningPath}`,
      cheaders
    );
    const listsofcourseed = await response.json();
    if (response.status == 200) {
  ...
  async function newcoursereviewercreate(adminemail) {
    ...
    try {
      const response = await fetch(
        `${process.env.REACT_APP_API_URL}/api/admin/addCourseReviewer`,
        {
          headers: {
            Accept: "application/json",
            "Content-Type": "application/json",
  ...
  async function deletecourseReviewer(roledata) {
    ...
    try {
      const response = await fetch(
        `${process.env.REACT_APP_API_URL}/api/admin/deleteCourseReviewer`,
        {
          headers: {
            Accept: "application/json",
            "Content-Type": "application/json",
      ...
      if (response.status == 200) {
        ...
        if(roledata.state !== 0)
        {
          ...
          toast.success(`Course Reviewer access has been revoked from ${roledata.courseId} course successfully`);
        }
      }
        listCourseReviewer(roledata.pageno, roledata.searchkey, roledata.seldep);
      }
    } catch {
      toast.dismiss(toastId);
      toast.error("Something went wrong");
  ...
  async function listCourseViewer(pageno, namer, learningPath) {
    ...
    try{
    const response = await fetch(
      `${process.env.REACT_APP_API_URL}/api/admin/listCourseViewer?pageNumber=${pageno}&name=${namer}&learningPath=${learningPath}`,
      cheaders
    );
    const listsofcourseed = await response.json();
    if (response.status == 200) {
  ...
  async function newcourseviewercreate(adminemail) {
    ...
    try {
      const response = await fetch(
        `${process.env.REACT_APP_API_URL}/api/admin/addCourseViewer`,
        {
          headers: {
            Accept: "application/json",
            "Content-Type": "application/json",
  ...
  async function deletecourseViewer(roledata) {
    ...
    try {
      const response = await fetch(
        `${process.env.REACT_APP_API_URL}/api/admin/deleteCourseViewer`,
        {
          headers: {
            Accept: "application/json",
            "Content-Type": "application/json",
      ...
      if (response.status == 200) {
        ...
        if(roledata.state !== 0)
        {
          ...
          toast.success(`Course Viewer access has been revoked from ${roledata.courseId} course successfully`);
        }
      }
  ...
  async function listConversionManager(pageno, namer) {
    ...
    try{
    const response = await fetch(
      `${process.env.REACT_APP_API_URL}/api/conversion/listConversionChecker?pageNumber=${pageno}&name=${namer}`,
      cheaders
    );
    const listsofcourseed = await response.json();
    if (response.status == 200) {
  ...
  async function newconversionmanageradd(adminemail) {
    ...
    try {
      const response = await fetch(
        `${process.env.REACT_APP_API_URL}/api/conversion/createConversionChecker`,
        {
          headers: {
            Accept: "application/json",
            "Content-Type": "application/json",
  ...
  async function deletecourseManager(roledata) {
    ...
    try {
      const response = await fetch(
        `${process.env.REACT_APP_API_URL}/api/conversion/deleteConversionChecker`,
        {
          headers: {
            Accept: "application/json",
            "Content-Type": "application/json",
      ...
      if (response.status == 200) {
        ...
        if(roledata.state !== 0)
        {
          ...
          toast.success(`Conversion Manager access has been revoked successfully`);
        }
      }
  ...
  async function listlpmanager(pageno, namer, learningPath) {
    ...
    try{
    const response = await fetch(
      `${process.env.REACT_APP_API_URL}/api/admin/listLpManager?pageNumber=${pageno}&learningPath=${learningPath}&name=${namer}`,
      cheaders
    );
    const listsofcourseed = await response.json();
    if (response.status == 200) {
  ...
  async function deleteLpManager(roledata) {
    ...
    try {
      const response = await fetch(
        `${process.env.REACT_APP_API_URL}/api/admin/deleteLpManager`,
        {
          headers: {
            Accept: "application/json",
            "Content-Type": "application/json",
      ...
      if (response.status == 200) {
        ...
        if(roledata.state !== 0)
        {
          ...
          toast.success(`Lp manager access has been revoked from ${roledata.learningPath} course successfully`);
        }
      }
  ...
  async function defaultcountapi() {
    const response = await fetch(
      `${process.env.REACT_APP_API_URL}/api/admin/countOfRole`,
      cheaders
    )
  ...
  async function innerlpteam(pageno, namer, learningPath, courseid) {
    const response = await fetch(
      `${process.env.REACT_APP_API_URL}/api/admin/listMemberFromlpTeam?pageNumber=${pageno}&learningPath=${learningPath}&courseId=${courseid}&name=${namer}`,
      cheaders
    );
    const listsofcourseed = await response.json();
    if (response.status == 200) {
  ...
  async function deleteinnerlp(roledata) {
    ...
    try {
      const response = await fetch(
        `${process.env.REACT_APP_API_URL}/api/admin/deleteMemberFromLpTeam`,
        {
          headers: {
            Accept: "application/json",
            "Content-Type": "application/json",
      ...
      if (response.status == 200) {
        ...
        if(roledata.state !== 0)
        {
          ...
          toast.success(`Member access has been revoked from ${roledata.courseId} course successfully`);
        }
      }
        innerlpteam(roledata.pageno, roledata.searchkey, roledata.learningPath, roledata.selcour);
      }
    } catch {
      toast.dismiss(toastId);
      toast.error("Something went wrong");
  ...
  async function newinnerlpteam(adminemail) {
    ...
    try {
      const response = await fetch(
        `${process.env.REACT_APP_API_URL}/api/admin/assignMemberToLpTeam`,
        {
          headers: {
            Accept: "application/json",
            "Content-Type": "application/json",
  ...
  async function createcustomrole(roledata) {
    ...
    try {
      const response = await fetch(
        `${process.env.REACT_APP_API_URL}/api/role/createCustomRole`,
        {
          headers: {
            Accept: "application/json",
            "Content-Type": "application/json",
  ...
  async function customdashvalues() {
    const response = await fetch(
      `${process.env.REACT_APP_API_URL}/api/admin/customRolesDashboard`,
      cheaders
    )
  ...
  async function listcustomdata(pageno, namer, roleid) {
    const response = await fetch(
      `${process.env.REACT_APP_API_URL}/api/admin/listMembersOfCustomRole?pageNumber=${pageno}&name=${namer}&customRoleId=${roleid}`,
      cheaders
    );
    const listsofcourseed = await response.json();
    if (response.status == 200) {
  ...
  async function scheduleinterview(data, page){
    ...
    try {
      const response = await fetch(
        `${process.env.REACT_APP_API_URL}/api/interview/scheduleInterview`,
        {
          headers: {
            Accept: "application/json",
            "Content-Type": "application/json",
  ...
  async function schedulingassistant(data){
    const response = await fetch(
      `${process.env.REACT_APP_API_URL}/api/interview/schedulingAssistant`,
      {
        headers: {
          Accept: "application/json",
          "Content-Type": "application/json",
...
async function postdetailsofinterviewdata(data, page){
  ...
  try {
  const response = await fetch(
    `${process.env.REACT_APP_API_URL}/api/interview/fillInterviewFeedback`,
    {
      headers: {
        Accept: "application/json",
        "Content-Type": "application/json",
...
async function getdetailsofinterviewdata(id){
  const response = await fetch(
    `${process.env.REACT_APP_API_URL}/api/interview/getInterviewFeedbackData?sInterviewId=${id}`,
    cheaders
      )
     const resofassistant = await response.json();
      if(response.status == 200){
...
async function deleteempofcustom(data){
  ...
  try{
  const response = await fetch(
    `${process.env.REACT_APP_API_URL}/api/admin/deleteMembersFromCustomRole`,
    {
      headers: {
        Accept: "application/json",
        "Content-Type": "application/json",
...
async function deletecustomrole(data){
  ...
  try{
  const response = await fetch(
    `${process.env.REACT_APP_API_URL}/api/role/deleteCustomRole`,
    {
      headers: {
        Accept: "application/json",
        "Content-Type": "application/json",
...
async function addcustommember(customdata){
  ...
  try{
    const response = await fetch(
      `${process.env.REACT_APP_API_URL}/api/admin/addMemberToCustomRole`,
      {
        headers: {
          Accept: "application/json",
          "Content-Type": "application/json",
          ...
          if(response.status == 200)
          {
            ...
            {
              toast.success(resofassistant.data.message)
              listcustomdata(customdata.pageno , customdata.searchkey, customdata.customRoleId)
            }
            else
            {
              toast.error(resofassistant.data.message)
...
async function depheadlist() {
  const response = await fetch(
    `${process.env.REACT_APP_API_URL}/api/departmentHead/listResources`,
    cheaders
  );
  ...
  if (response.status === 200) {
    dispatch({
      type: "DEPRES_LIST",
      payload: depres.data.result,
    });
    dispatch({
      type: "DEPARTMENT_HEAD_DEPS",
      payload: depres.data.distinctDepartment,
    });
  } else {
    console.error();
  }
}
async function depheadConversionList(
  page,
  department,
  name,
  type,
  ...
  const response = await fetch(
    `${process.env.REACT_APP_API_URL}/api/departmentHead/listResourcesConversion?from=${from ? from : ""
    }&to=${to ? to : ""}&conversionType=${type ? type : ""}&name=${name ? name : ""
    }&pageNumber=${page}`,
    {
      headers: {
...
async function downreportforcomcon(
  department,
  name,
  type,
  from,
  ...
  const response = await fetch(
    `${process.env.REACT_APP_API_URL}/api/conversion/downloadListConversionMonthDetailForChecker?from=${from ? from : ""
  }&to=${to ? to : ""}&conversionType=${type ? type : ""}&name=${name ? name : ""
  }`,
    {
      headers: {
...
try{
  const response = await fetch(
    `${process.env.REACT_APP_API_URL}/api/admin/assignDepartmentToLps`,
    {
      headers: {
        Accept: "application/json",
        "Content-Type": "application/json",
...
async function coursecreating(coursedata){
  ...
  try{
    const response = await fetch(
      `${process.env.REACT_APP_API_URL}/api/courses/ongoingCourseCreationUpload`,
      {
        headers: {
          Accept: "application/json",
          "Content-Type": "application/json",
...
async function getdepoflp(lpname){
    const response = await fetch(
      `${process.env.REACT_APP_API_URL}/api/learningPath/getDepartmentOfLp?lp=${lpname}`,
      cheaders
    )
...
async function gettllist(){
  const response = await fetch(
    `${process.env.REACT_APP_API_URL}/api/conversion/listTeamLead`,
    cheaders
  )
...
async function submitcourse(coursedata){
  ...
  try{
    const response = await fetch(
      `${process.env.REACT_APP_API_URL}/api/courses/ongoingCourseCreationContent`,
      {
        headers: {
          Accept: "application/json",
          "Content-Type": "application/json",
...
async function getupdatedcourse(courseid){
  const response = await fetch(
    `${process.env.REACT_APP_API_URL}/api/courses/getOngoingCourseCreationContent?courseId=${courseid}`,
    cheaders
  )
  const resofcourse = await response.json();
  if(response.status == 200)
  {
    ...
    const temp = {...resofcourse.data, type:"Save", coursevalues:coursevalues, finalAssessment:finalAssessment};
    if(sessionStorage)
    {
...
async function postcomment(data){
  ...
  try{
    const response = await fetch(
      `${process.env.REACT_APP_API_URL}/api/courses/addCommentsToUnderDevelopmentCourse`,
      {
        headers: {
          Accept: "application/json",
          "Content-Type": "application/json",
...
async function getcomments(courseid){
  const response = await fetch(
    `${process.env.REACT_APP_API_URL}/api/courses/getCommentsOfUnderDevelopmentCourse?courseId=${courseid}`,
    cheaders
  )
...
const toastId = toast.loading("Requesting...");
  try{
  const response = await fetch(
    `${process.env.REACT_APP_API_URL}/api/courses/sendCourseForApproalByEditor`,
    {
      headers: {
        Accept: "application/json",
        "Content-Type": "application/json",
...
async function getroleforpreview(lp, course){
  const response = await fetch(
    `${process.env.REACT_APP_API_URL}/api/courses/getRoleForLearningPathManagementOfSpecificCourse?courseId=${course}&learningPath=${lp}`,
    cheaders
  )
...
const toastId = toast.loading("Requesting...");
  try{
  const response = await fetch(
    `${process.env.REACT_APP_API_URL}/api/courses/reviewerPublishCourse`,
    {
      headers: {
        Accept: "application/json",
        "Content-Type": "application/json",
...
async function listinterviewers(pageno, namer) {
  ...
  try{
  const response = await fetch(
    `${process.env.REACT_APP_API_URL}/api/admin/listInterviewSchedular?pageNumber=${pageno}&name=${namer}`,
    cheaders
  );
  const lists = await response.json();
  if (response.status == 200) {
...
async function deleteInterviewer(roledata) {
  ...
  try {
    const response = await fetch(
      `${process.env.REACT_APP_API_URL}/api/admin/deleteInterviewSchedular`,
      {
        headers: {
          Accept: "application/json",
          "Content-Type": "application/json",
...
async function newinterviewercreate(adminemail) {
  ...
  try {
    const response = await fetch(
      `${process.env.REACT_APP_API_URL}/api/admin/addInterviewSchedular`,
      {
        headers: {
          Accept: "application/json",
          "Content-Type": "application/json",
...
async function listteamleads(pageno, namer) {
  ...
  try{
  const response = await fetch(
    `${process.env.REACT_APP_API_URL}/api/admin/listAllTeamLead?pageNumber=${pageno}&name=${namer}`,
    cheaders
  );
  const lists = await response.json();
  if (response.status == 200) {
...
async function deleteTeamlead(roledata) {
  ...
  try {
    const response = await fetch(
      `${process.env.REACT_APP_API_URL}/api/admin/deleteTeamLead`,
      {
        headers: {
          Accept: "application/json",
          "Content-Type": "application/json",
...
async function newteamleadcreate(adminemail) {
  ...
  try {
    const response = await fetch(
      `${process.env.REACT_APP_API_URL}/api/admin/addTeamLead`,
      {
        headers: {
          Accept: "application/json",
          "Content-Type": "application/json",
...
async function downreportforadminemp(
  ...
  const response = await fetch(
    `${process.env.REACT_APP_API_URL}/api/admin/downloadAdminDashboardData`,
    {
      headers: {
        Accept: "application/json",
        "Content-Type": "application/json",
...
async function getallusersforfiles(){
    const response = await fetch(
      `${process.env.REACT_APP_API_URL}/api/dataEvaluation/getAllFile?emailId=`,
      cheaders
    )
  ...
  return (
    <GlobalContext.Provider
      value={{
        ...
        // getprofilephto,
        depheaddepartmentslist: state.depheaddepartmentslist,
        cmlist: state.cmlist,
        ...
        buddydepartlist:state.buddydepartlist,
