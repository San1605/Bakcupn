...
const TableCheckbox = ({ projectData, height ,selectedItems, setSelectedItems }) => {
            ...
            <table className="w-full text-sm text-left rtl:text-right font-normal shadow-sm  bg-white">
                <thead className="text-sm text-[#242424]  bg-[#ebebeb]  sticky top-0">
                    <tr>
                        ...
                        <th scope="col" className="px-6 py-3 w-4/12">File Name</th>
                        <th scope="col" className="px-6 py-3 w-1/4">File Type</th>
                        <th scope="col" className="px-6 py-3 w-1/4">Date Modified</th>
                    </tr>
                </thead>
                <tbody>
                    {projectData && projectData?.length > 0 && projectData?.map((item, index) => (
                        <tr
                            key={index}
