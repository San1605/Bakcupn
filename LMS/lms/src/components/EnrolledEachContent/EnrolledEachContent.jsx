...
import "./EnrolledEachContent.css";
import dropdown from "../../assets/dropdown.svg";
import playvideo from "../../assets/playvideo.svg";
import videoComplete from "../../assets/videoComplete.svg";
import readComplete from "../../assets/readComplete.svg";
...
function EnrolledeachContent(props) {
  ...
  return (
    <div className="px-2 py-2 justify-content-between border-bottom ">
      <div
        className="moduleheading  pointer justify-content-around"
